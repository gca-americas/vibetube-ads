...
# vibetube-XXXX. Project IDs are unique across all of Google Cloud and a
...
# IAM policy propagates. ./scripts/start.sh makes real Gemini and BigQuery calls
# almost immediately, so absorb that wait here instead of failing there.
