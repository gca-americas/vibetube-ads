...
ORDER BY timestamp DESC LIMIT 10;""", language="sql")
    ...
    with tab3:
        ...
        st.write("Run the hardcoded rule script. Observe how the static rules fail to adapt to competitor auction pressure, sending your campaign into a **Death Spiral** where you deplete your budget on a single category and lose entirely in competitive categories.")
